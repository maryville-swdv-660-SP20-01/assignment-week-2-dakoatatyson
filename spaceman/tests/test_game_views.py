...
class GameApiViewTests( TestCase ):
    ...
    def test_get_solution_should_respond_with_404_when_id_not_found( self ):
        with patch.object( Game.objects, 'get' ) as mock_get:
    ...
    def test_get_solution_should_respond_with_solution_word_json( self ):
        with patch.object( Game.objects, 'get' ) as mock_get:
            mock_get.return_value = self.mock_game
